        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="border rounded-lg p-4">
              <img
                src="https://www.trawell.in/admin/images/upload/103055465Mathura_Krishna_Janmabhoomi_Temple_Main.jpg"              alt="Shri Krishna Janmabhoomi Temple"
                className="mb-4"
                width="300"
                height="200"
              />
            ...
            <div className="border rounded-lg p-4">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwLvUrY0P6Waxtv9GKJ9zm_LCS1UQP-9e-1A&s"      alt="Dwarkadhish Temple"
                className="mb-4"
                width="300"
                height="200"
              />
            ...
            <div className="border rounded-lg p-4">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTllry4vkK985pj4wyHwuDYPJuvujd7dE6lQQ&s"        alt="Gita Mandir"
                className="mb-4"
                width="300"
                height="200"
              />
            ...
            <div className="border rounded-lg p-4">
              <img
                src="https://www.holidify.com/images/cmsuploads/compressed/800px-Vishram_Ghat_20200428142441.jpg"          alt="Vishram Ghat"
                className="mb-4"
                width="300"
                height="200"
              />
            ...
            <div className="border rounded-lg p-4">
              <img
                src="https://cdn.britannica.com/06/195006-138-993E69CA/Ganges-River-tributary-human-rights-Yamuna-2017.jpg?w=400&h=225&c=crop"         alt="Yamuna River Ghats"
                className="mb-4"
                width="300"
                height="200"
              />
            ...
            <div className="border rounded-lg p-4">
              <img
                src="https://stominindia.com/wp-content/uploads/2023/05/Govardhan-Parikrama.jpg"        alt="Govardhan Hill"
                className="mb-4"
                width="300"
                height="200"
              />
